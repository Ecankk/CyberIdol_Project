...
def scan_single_model(model_id: str, model_path: str) -> dict:
    ...
    metadata = {
        ...
        "live2d_config": existing.get("live2d_config", {}),
        "motions": existing.get("motions", {}),
        "expressions": existing.get("expressions", {}),
        "emotion_to_expression": existing.get("emotion_to_expression", {}),
        "gpt_filename": "",
        "sovits_filename": "",
